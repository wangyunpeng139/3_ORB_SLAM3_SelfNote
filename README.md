...
* 2020-07-24 ：解决了未定义错误和编译时候的警告信息

  > * 在g2o和ORB_SLAM3中的CMaKeLists.txt中添加`add_definitions(-w)`禁止显示gcc的编译警告信息
  > * 修改ORB_SLAM3中的CMaKeLists.txt，定义opencv=3.4解决未定义报错
  > * 修改了build.sh文件

* 2020-08-08：同步ORB_SLAM3

  > - [x] 9ddba33（这是2020-08-04日提交的）

* 2020-08-13：同步ORB_SLAM3

  > - [x] adc4062     (这是2020-08-10日提交的）

* 2020-09-14: 同步ORB_SLAM3
...
```shell
pathDatasetEuroc='/home/wyp/dataset/EuRoC'
...
![image-20201125223548069](picture/image-20201125223548069.png)

> **注意：上面i代表上一帧，j表示当前帧**
>
> ei : VIO误差（对于这一部分雅克比是9*24的，通过J^T * information * J得到Hession矩阵后，就变成24*24了）
>
> egr : 陀螺仪随机游走误差
>
> ear : 加速度随机游走误差
...
> ep : 先验误差
>
> evo:纯视觉（这一部分是累加了所有的点的投影误差计算出来的，对应的雅克比矩阵**旋转在前，位移在后**）





# :star: :star: :star: :star: :star: 原作者READEME
